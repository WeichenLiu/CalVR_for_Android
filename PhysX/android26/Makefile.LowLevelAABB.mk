...
LowLevelAABB_debug_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
LowLevelAABB_debug_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
LowLevelAABB_debug_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
LowLevelAABB_debug_common_cflags  += -march=armv8-a  -marm 
LowLevelAABB_debug_common_cflags  += -w
LowLevelAABB_debug_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
LowLevelAABB_debug_cflags  += -std=gnu11
LowLevelAABB_debug_cppflags	:= $(LowLevelAABB_debug_common_cflags)
LowLevelAABB_debug_cppflags  += -std=gnu++17 -fno-rtti
...
LowLevelAABB_debug_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
LowLevelAABB_debug_bin      := ./../../../Lib/android26/libLowLevelAABBDEBUG.a
...
$(LowLevelAABB_debug_bin): $(LowLevelAABB_debug_obj) 
	mkdir -p `dirname ./../../../Lib/android26/libLowLevelAABBDEBUG.a`
...
$(LowLevelAABB_debug_cpp_o): $(LowLevelAABB_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(LowLevelAABB_debug_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(LowLevelAABB_debug_objsdir),, $@))), $(LowLevelAABB_cppfiles)) -o $@
...
$(LowLevelAABB_debug_cc_o): $(LowLevelAABB_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(LowLevelAABB_debug_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(LowLevelAABB_debug_objsdir),, $@))), $(LowLevelAABB_ccfiles)) -o $@
...
$(LowLevelAABB_debug_c_o): $(LowLevelAABB_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(LowLevelAABB_debug_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(LowLevelAABB_debug_objsdir),, $@))), $(LowLevelAABB_cfiles)) -o $@ 
...
LowLevelAABB_checked_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
LowLevelAABB_checked_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
LowLevelAABB_checked_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
LowLevelAABB_checked_common_cflags  += -march=armv8-a  -marm 
LowLevelAABB_checked_common_cflags  += -w
LowLevelAABB_checked_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
LowLevelAABB_checked_common_cflags  += -fomit-frame-pointer  
LowLevelAABB_checked_cflags	:= $(LowLevelAABB_checked_common_cflags)
LowLevelAABB_checked_cflags  += -std=gnu11
LowLevelAABB_checked_cppflags	:= $(LowLevelAABB_checked_common_cflags)
LowLevelAABB_checked_cppflags  += -std=gnu++17 -fno-rtti
...
LowLevelAABB_checked_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
LowLevelAABB_checked_bin      := ./../../../Lib/android26/libLowLevelAABBCHECKED.a
...
$(LowLevelAABB_checked_bin): $(LowLevelAABB_checked_obj) 
	mkdir -p `dirname ./../../../Lib/android26/libLowLevelAABBCHECKED.a`
...
$(LowLevelAABB_checked_cpp_o): $(LowLevelAABB_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(LowLevelAABB_checked_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(LowLevelAABB_checked_objsdir),, $@))), $(LowLevelAABB_cppfiles)) -o $@
...
$(LowLevelAABB_checked_cc_o): $(LowLevelAABB_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(LowLevelAABB_checked_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(LowLevelAABB_checked_objsdir),, $@))), $(LowLevelAABB_ccfiles)) -o $@
...
$(LowLevelAABB_checked_c_o): $(LowLevelAABB_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(LowLevelAABB_checked_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(LowLevelAABB_checked_objsdir),, $@))), $(LowLevelAABB_cfiles)) -o $@ 
...
LowLevelAABB_profile_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
LowLevelAABB_profile_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
LowLevelAABB_profile_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
LowLevelAABB_profile_common_cflags  += -march=armv8-a  -marm 
LowLevelAABB_profile_common_cflags  += -w
LowLevelAABB_profile_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
LowLevelAABB_profile_common_cflags  += -fno-omit-frame-pointer  
LowLevelAABB_profile_cflags	:= $(LowLevelAABB_profile_common_cflags)
LowLevelAABB_profile_cflags  += -std=gnu11
LowLevelAABB_profile_cppflags	:= $(LowLevelAABB_profile_common_cflags)
LowLevelAABB_profile_cppflags  += -std=gnu++17 -fno-rtti
...
LowLevelAABB_profile_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
LowLevelAABB_profile_bin      := ./../../../Lib/android26/libLowLevelAABBPROFILE.a
...
$(LowLevelAABB_profile_bin): $(LowLevelAABB_profile_obj) 
	mkdir -p `dirname ./../../../Lib/android26/libLowLevelAABBPROFILE.a`
...
$(LowLevelAABB_profile_cpp_o): $(LowLevelAABB_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(LowLevelAABB_profile_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(LowLevelAABB_profile_objsdir),, $@))), $(LowLevelAABB_cppfiles)) -o $@
...
$(LowLevelAABB_profile_cc_o): $(LowLevelAABB_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(LowLevelAABB_profile_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(LowLevelAABB_profile_objsdir),, $@))), $(LowLevelAABB_ccfiles)) -o $@
...
$(LowLevelAABB_profile_c_o): $(LowLevelAABB_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(LowLevelAABB_profile_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(LowLevelAABB_profile_objsdir),, $@))), $(LowLevelAABB_cfiles)) -o $@ 
...
LowLevelAABB_release_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
LowLevelAABB_release_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
LowLevelAABB_release_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
LowLevelAABB_release_common_cflags  += -march=armv8-a  -marm 
LowLevelAABB_release_common_cflags  += -w
LowLevelAABB_release_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
LowLevelAABB_release_common_cflags  += -fomit-frame-pointer  
LowLevelAABB_release_cflags	:= $(LowLevelAABB_release_common_cflags)
LowLevelAABB_release_cflags  += -std=gnu11
LowLevelAABB_release_cppflags	:= $(LowLevelAABB_release_common_cflags)
LowLevelAABB_release_cppflags  += -std=gnu++17 -fno-rtti
...
LowLevelAABB_release_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
LowLevelAABB_release_bin      := ./../../../Lib/android26/libLowLevelAABB.a
...
$(LowLevelAABB_release_bin): $(LowLevelAABB_release_obj) 
	mkdir -p `dirname ./../../../Lib/android26/libLowLevelAABB.a`
...
$(LowLevelAABB_release_cpp_o): $(LowLevelAABB_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(LowLevelAABB_release_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(LowLevelAABB_release_objsdir),, $@))), $(LowLevelAABB_cppfiles)) -o $@
...
$(LowLevelAABB_release_cc_o): $(LowLevelAABB_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(LowLevelAABB_release_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(LowLevelAABB_release_objsdir),, $@))), $(LowLevelAABB_ccfiles)) -o $@
...
$(LowLevelAABB_release_c_o): $(LowLevelAABB_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(LowLevelAABB_release_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(LowLevelAABB_release_objsdir),, $@))), $(LowLevelAABB_cfiles)) -o $@ 
