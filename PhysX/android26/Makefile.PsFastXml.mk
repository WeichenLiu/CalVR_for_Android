...
PsFastXml_debug_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
PsFastXml_debug_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
PsFastXml_debug_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
PsFastXml_debug_common_cflags  += -march=armv8-a  -marm 
...
PsFastXml_debug_cppflags  += -std=gnu++17 -fno-rtti
...
PsFastXml_debug_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
PsFastXml_debug_bin      := ./../../../../PxShared/Lib/android26/libPsFastXmlDEBUG.a
...
$(PsFastXml_debug_bin): $(PsFastXml_debug_obj) 
	mkdir -p `dirname ./../../../../PxShared/Lib/android26/libPsFastXmlDEBUG.a`
...
$(PsFastXml_debug_cpp_o): $(PsFastXml_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PsFastXml_debug_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PsFastXml_debug_objsdir),, $@))), $(PsFastXml_cppfiles)) -o $@
...
$(PsFastXml_debug_cc_o): $(PsFastXml_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PsFastXml_debug_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PsFastXml_debug_objsdir),, $@))), $(PsFastXml_ccfiles)) -o $@
...
$(PsFastXml_debug_c_o): $(PsFastXml_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(PsFastXml_debug_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(PsFastXml_debug_objsdir),, $@))), $(PsFastXml_cfiles)) -o $@ 
...
PsFastXml_release_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
PsFastXml_release_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
PsFastXml_release_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
PsFastXml_release_common_cflags  += -march=armv8-a  -marm 
...
PsFastXml_release_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
PsFastXml_release_bin      := ./../../../../PxShared/Lib/android26/libPsFastXml.a
...
$(PsFastXml_release_bin): $(PsFastXml_release_obj) 
	mkdir -p `dirname ./../../../../PxShared/Lib/android26/libPsFastXml.a`
...
$(PsFastXml_release_cpp_o): $(PsFastXml_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PsFastXml_release_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PsFastXml_release_objsdir),, $@))), $(PsFastXml_cppfiles)) -o $@
...
$(PsFastXml_release_cc_o): $(PsFastXml_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PsFastXml_release_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PsFastXml_release_objsdir),, $@))), $(PsFastXml_ccfiles)) -o $@
...
$(PsFastXml_release_c_o): $(PsFastXml_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(PsFastXml_release_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(PsFastXml_release_objsdir),, $@))), $(PsFastXml_cfiles)) -o $@ 
...
PsFastXml_checked_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
PsFastXml_checked_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
PsFastXml_checked_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
PsFastXml_checked_common_cflags  += -march=armv8-a  -marm 
...
PsFastXml_checked_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
PsFastXml_checked_bin      := ./../../../../PxShared/Lib/android26/libPsFastXmlCHECKED.a
...
$(PsFastXml_checked_bin): $(PsFastXml_checked_obj) 
	mkdir -p `dirname ./../../../../PxShared/Lib/android26/libPsFastXmlCHECKED.a`
...
$(PsFastXml_checked_cpp_o): $(PsFastXml_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PsFastXml_checked_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PsFastXml_checked_objsdir),, $@))), $(PsFastXml_cppfiles)) -o $@
...
$(PsFastXml_checked_cc_o): $(PsFastXml_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PsFastXml_checked_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PsFastXml_checked_objsdir),, $@))), $(PsFastXml_ccfiles)) -o $@
...
$(PsFastXml_checked_c_o): $(PsFastXml_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(PsFastXml_checked_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(PsFastXml_checked_objsdir),, $@))), $(PsFastXml_cfiles)) -o $@ 
...
PsFastXml_profile_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
PsFastXml_profile_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
PsFastXml_profile_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
PsFastXml_profile_common_cflags  += -march=armv8-a  -marm 
...
PsFastXml_profile_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
PsFastXml_profile_bin      := ./../../../../PxShared/Lib/android26/libPsFastXmlPROFILE.a
...
$(PsFastXml_profile_bin): $(PsFastXml_profile_obj) 
	mkdir -p `dirname ./../../../../PxShared/Lib/android26/libPsFastXmlPROFILE.a`
...
$(PsFastXml_profile_cpp_o): $(PsFastXml_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PsFastXml_profile_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PsFastXml_profile_objsdir),, $@))), $(PsFastXml_cppfiles)) -o $@
...
$(PsFastXml_profile_cc_o): $(PsFastXml_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PsFastXml_profile_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PsFastXml_profile_objsdir),, $@))), $(PsFastXml_ccfiles)) -o $@
...
$(PsFastXml_profile_c_o): $(PsFastXml_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(PsFastXml_profile_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(PsFastXml_profile_objsdir),, $@))), $(PsFastXml_cfiles)) -o $@ 
