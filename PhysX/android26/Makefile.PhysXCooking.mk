...
PhysXCooking_release_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
PhysXCooking_release_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
PhysXCooking_release_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
PhysXCooking_release_common_cflags  += -march=armv8-a  -marm 
PhysXCooking_release_common_cflags  += -w
PhysXCooking_release_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
PhysXCooking_release_common_cflags  += -fomit-frame-pointer 
PhysXCooking_release_cflags	:= $(PhysXCooking_release_common_cflags)
PhysXCooking_release_cflags  += -std=gnu11
PhysXCooking_release_cppflags	:= $(PhysXCooking_release_common_cflags)
PhysXCooking_release_cppflags  += -std=gnu++17 -fno-rtti
...
PhysXCooking_release_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
PhysXCooking_release_bin      := ./../../../Lib/android26/libPhysX3Cooking.a
...
$(PhysXCooking_release_bin): $(PhysXCooking_release_obj) build_PxFoundation_release build_PhysXCommon_release build_PhysXExtensions_release 
	mkdir -p `dirname ./../../../Lib/android26/libPhysX3Cooking.a`
...
$(PhysXCooking_release_cpp_o): $(PhysXCooking_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PhysXCooking_release_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PhysXCooking_release_objsdir),, $@))), $(PhysXCooking_cppfiles)) -o $@
...
$(PhysXCooking_release_cc_o): $(PhysXCooking_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PhysXCooking_release_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PhysXCooking_release_objsdir),, $@))), $(PhysXCooking_ccfiles)) -o $@
...
$(PhysXCooking_release_c_o): $(PhysXCooking_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(PhysXCooking_release_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(PhysXCooking_release_objsdir),, $@))), $(PhysXCooking_cfiles)) -o $@ 
...
PhysXCooking_debug_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
PhysXCooking_debug_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
PhysXCooking_debug_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
PhysXCooking_debug_common_cflags  += -march=armv8-a  -marm 
PhysXCooking_debug_common_cflags  += -w
PhysXCooking_debug_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
PhysXCooking_debug_cflags  += -std=gnu11
PhysXCooking_debug_cppflags	:= $(PhysXCooking_debug_common_cflags)
PhysXCooking_debug_cppflags  += -std=gnu++17 -fno-rtti
...
PhysXCooking_debug_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
PhysXCooking_debug_bin      := ./../../../Lib/android26/libPhysX3CookingDEBUG.a
...
$(PhysXCooking_debug_bin): $(PhysXCooking_debug_obj) build_PxFoundation_debug build_PhysXCommon_debug build_PhysXExtensions_debug 
	mkdir -p `dirname ./../../../Lib/android26/libPhysX3CookingDEBUG.a`
...
$(PhysXCooking_debug_cpp_o): $(PhysXCooking_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PhysXCooking_debug_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PhysXCooking_debug_objsdir),, $@))), $(PhysXCooking_cppfiles)) -o $@
...
$(PhysXCooking_debug_cc_o): $(PhysXCooking_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PhysXCooking_debug_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PhysXCooking_debug_objsdir),, $@))), $(PhysXCooking_ccfiles)) -o $@
...
$(PhysXCooking_debug_c_o): $(PhysXCooking_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(PhysXCooking_debug_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(PhysXCooking_debug_objsdir),, $@))), $(PhysXCooking_cfiles)) -o $@ 
...
PhysXCooking_checked_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
PhysXCooking_checked_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
PhysXCooking_checked_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
PhysXCooking_checked_common_cflags  += -march=armv8-a  -marm 
PhysXCooking_checked_common_cflags  += -w
PhysXCooking_checked_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
PhysXCooking_checked_common_cflags  += -fomit-frame-pointer 
PhysXCooking_checked_cflags	:= $(PhysXCooking_checked_common_cflags)
PhysXCooking_checked_cflags  += -std=gnu11
PhysXCooking_checked_cppflags	:= $(PhysXCooking_checked_common_cflags)
PhysXCooking_checked_cppflags  += -std=gnu++17 -fno-rtti
...
PhysXCooking_checked_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
PhysXCooking_checked_bin      := ./../../../Lib/android26/libPhysX3CookingCHECKED.a
...
$(PhysXCooking_checked_bin): $(PhysXCooking_checked_obj) build_PxFoundation_checked build_PhysXCommon_checked build_PhysXExtensions_checked 
	mkdir -p `dirname ./../../../Lib/android26/libPhysX3CookingCHECKED.a`
...
$(PhysXCooking_checked_cpp_o): $(PhysXCooking_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PhysXCooking_checked_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PhysXCooking_checked_objsdir),, $@))), $(PhysXCooking_cppfiles)) -o $@
...
$(PhysXCooking_checked_cc_o): $(PhysXCooking_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PhysXCooking_checked_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PhysXCooking_checked_objsdir),, $@))), $(PhysXCooking_ccfiles)) -o $@
...
$(PhysXCooking_checked_c_o): $(PhysXCooking_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(PhysXCooking_checked_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(PhysXCooking_checked_objsdir),, $@))), $(PhysXCooking_cfiles)) -o $@ 
...
PhysXCooking_profile_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
PhysXCooking_profile_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
PhysXCooking_profile_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
PhysXCooking_profile_common_cflags  += -march=armv8-a  -marm 
PhysXCooking_profile_common_cflags  += -w
PhysXCooking_profile_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
PhysXCooking_profile_common_cflags  += -fno-omit-frame-pointer 
PhysXCooking_profile_cflags	:= $(PhysXCooking_profile_common_cflags)
PhysXCooking_profile_cflags  += -std=gnu11
PhysXCooking_profile_cppflags	:= $(PhysXCooking_profile_common_cflags)
PhysXCooking_profile_cppflags  += -std=gnu++17 -fno-rtti
...
PhysXCooking_profile_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
PhysXCooking_profile_bin      := ./../../../Lib/android26/libPhysX3CookingPROFILE.a
...
$(PhysXCooking_profile_bin): $(PhysXCooking_profile_obj) build_PxFoundation_profile build_PhysXCommon_profile build_PhysXExtensions_profile 
	mkdir -p `dirname ./../../../Lib/android26/libPhysX3CookingPROFILE.a`
...
$(PhysXCooking_profile_cpp_o): $(PhysXCooking_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PhysXCooking_profile_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PhysXCooking_profile_objsdir),, $@))), $(PhysXCooking_cppfiles)) -o $@
...
$(PhysXCooking_profile_cc_o): $(PhysXCooking_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PhysXCooking_profile_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PhysXCooking_profile_objsdir),, $@))), $(PhysXCooking_ccfiles)) -o $@
...
$(PhysXCooking_profile_c_o): $(PhysXCooking_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(PhysXCooking_profile_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(PhysXCooking_profile_objsdir),, $@))), $(PhysXCooking_cfiles)) -o $@ 
