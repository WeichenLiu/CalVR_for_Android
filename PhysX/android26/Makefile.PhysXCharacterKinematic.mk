...
PhysXCharacterKinematic_debug_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
PhysXCharacterKinematic_debug_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
PhysXCharacterKinematic_debug_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
PhysXCharacterKinematic_debug_common_cflags  += -march=armv8-a  -marm 
PhysXCharacterKinematic_debug_common_cflags  += -w
PhysXCharacterKinematic_debug_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
PhysXCharacterKinematic_debug_cflags  += -std=gnu11
PhysXCharacterKinematic_debug_cppflags	:= $(PhysXCharacterKinematic_debug_common_cflags)
PhysXCharacterKinematic_debug_cppflags  += -std=gnu++17 -fno-rtti
...
PhysXCharacterKinematic_debug_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
PhysXCharacterKinematic_debug_bin      := ./../../../Lib/android26/libPhysX3CharacterKinematicDEBUG.a
...
$(PhysXCharacterKinematic_debug_bin): $(PhysXCharacterKinematic_debug_obj) build_PhysXExtensions_debug build_PxFoundation_debug build_PhysXCommon_debug 
	mkdir -p `dirname ./../../../Lib/android26/libPhysX3CharacterKinematicDEBUG.a`
...
$(PhysXCharacterKinematic_debug_cpp_o): $(PhysXCharacterKinematic_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PhysXCharacterKinematic_debug_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PhysXCharacterKinematic_debug_objsdir),, $@))), $(PhysXCharacterKinematic_cppfiles)) -o $@
...
$(PhysXCharacterKinematic_debug_cc_o): $(PhysXCharacterKinematic_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PhysXCharacterKinematic_debug_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PhysXCharacterKinematic_debug_objsdir),, $@))), $(PhysXCharacterKinematic_ccfiles)) -o $@
...
$(PhysXCharacterKinematic_debug_c_o): $(PhysXCharacterKinematic_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(PhysXCharacterKinematic_debug_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(PhysXCharacterKinematic_debug_objsdir),, $@))), $(PhysXCharacterKinematic_cfiles)) -o $@ 
...
PhysXCharacterKinematic_checked_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
PhysXCharacterKinematic_checked_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
PhysXCharacterKinematic_checked_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
PhysXCharacterKinematic_checked_common_cflags  += -march=armv8-a  -marm 
PhysXCharacterKinematic_checked_common_cflags  += -w
PhysXCharacterKinematic_checked_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
PhysXCharacterKinematic_checked_common_cflags  += -fomit-frame-pointer  
PhysXCharacterKinematic_checked_cflags	:= $(PhysXCharacterKinematic_checked_common_cflags)
PhysXCharacterKinematic_checked_cflags  += -std=gnu11
PhysXCharacterKinematic_checked_cppflags	:= $(PhysXCharacterKinematic_checked_common_cflags)
PhysXCharacterKinematic_checked_cppflags  += -std=gnu++17 -fno-rtti
...
PhysXCharacterKinematic_checked_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
PhysXCharacterKinematic_checked_bin      := ./../../../Lib/android26/libPhysX3CharacterKinematicCHECKED.a
...
$(PhysXCharacterKinematic_checked_bin): $(PhysXCharacterKinematic_checked_obj) build_PhysXExtensions_checked build_PxFoundation_checked build_PhysXCommon_checked 
	mkdir -p `dirname ./../../../Lib/android26/libPhysX3CharacterKinematicCHECKED.a`
...
$(PhysXCharacterKinematic_checked_cpp_o): $(PhysXCharacterKinematic_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PhysXCharacterKinematic_checked_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PhysXCharacterKinematic_checked_objsdir),, $@))), $(PhysXCharacterKinematic_cppfiles)) -o $@
...
$(PhysXCharacterKinematic_checked_cc_o): $(PhysXCharacterKinematic_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PhysXCharacterKinematic_checked_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PhysXCharacterKinematic_checked_objsdir),, $@))), $(PhysXCharacterKinematic_ccfiles)) -o $@
...
$(PhysXCharacterKinematic_checked_c_o): $(PhysXCharacterKinematic_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(PhysXCharacterKinematic_checked_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(PhysXCharacterKinematic_checked_objsdir),, $@))), $(PhysXCharacterKinematic_cfiles)) -o $@ 
...
PhysXCharacterKinematic_profile_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
PhysXCharacterKinematic_profile_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
PhysXCharacterKinematic_profile_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
PhysXCharacterKinematic_profile_common_cflags  += -march=armv8-a  -marm 
PhysXCharacterKinematic_profile_common_cflags  += -w
PhysXCharacterKinematic_profile_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
PhysXCharacterKinematic_profile_common_cflags  += -fno-omit-frame-pointer  
PhysXCharacterKinematic_profile_cflags	:= $(PhysXCharacterKinematic_profile_common_cflags)
PhysXCharacterKinematic_profile_cflags  += -std=gnu11
PhysXCharacterKinematic_profile_cppflags	:= $(PhysXCharacterKinematic_profile_common_cflags)
PhysXCharacterKinematic_profile_cppflags  += -std=gnu++17 -fno-rtti
...
PhysXCharacterKinematic_profile_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
PhysXCharacterKinematic_profile_bin      := ./../../../Lib/android26/libPhysX3CharacterKinematicPROFILE.a
...
$(PhysXCharacterKinematic_profile_bin): $(PhysXCharacterKinematic_profile_obj) build_PhysXExtensions_profile build_PxFoundation_profile build_PhysXCommon_profile 
	mkdir -p `dirname ./../../../Lib/android26/libPhysX3CharacterKinematicPROFILE.a`
...
$(PhysXCharacterKinematic_profile_cpp_o): $(PhysXCharacterKinematic_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PhysXCharacterKinematic_profile_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PhysXCharacterKinematic_profile_objsdir),, $@))), $(PhysXCharacterKinematic_cppfiles)) -o $@
...
$(PhysXCharacterKinematic_profile_cc_o): $(PhysXCharacterKinematic_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PhysXCharacterKinematic_profile_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PhysXCharacterKinematic_profile_objsdir),, $@))), $(PhysXCharacterKinematic_ccfiles)) -o $@
...
$(PhysXCharacterKinematic_profile_c_o): $(PhysXCharacterKinematic_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(PhysXCharacterKinematic_profile_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(PhysXCharacterKinematic_profile_objsdir),, $@))), $(PhysXCharacterKinematic_cfiles)) -o $@ 
...
PhysXCharacterKinematic_release_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
PhysXCharacterKinematic_release_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
PhysXCharacterKinematic_release_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
PhysXCharacterKinematic_release_common_cflags  += -march=armv8-a  -marm 
PhysXCharacterKinematic_release_common_cflags  += -w
PhysXCharacterKinematic_release_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
PhysXCharacterKinematic_release_common_cflags  += -fomit-frame-pointer  
PhysXCharacterKinematic_release_cflags	:= $(PhysXCharacterKinematic_release_common_cflags)
PhysXCharacterKinematic_release_cflags  += -std=gnu11
PhysXCharacterKinematic_release_cppflags	:= $(PhysXCharacterKinematic_release_common_cflags)
PhysXCharacterKinematic_release_cppflags  += -std=gnu++17 -fno-rtti
...
PhysXCharacterKinematic_release_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
PhysXCharacterKinematic_release_bin      := ./../../../Lib/android26/libPhysX3CharacterKinematic.a
...
$(PhysXCharacterKinematic_release_bin): $(PhysXCharacterKinematic_release_obj) build_PhysXExtensions_release build_PxFoundation_release build_PhysXCommon_release 
	mkdir -p `dirname ./../../../Lib/android26/libPhysX3CharacterKinematic.a`
...
$(PhysXCharacterKinematic_release_cpp_o): $(PhysXCharacterKinematic_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PhysXCharacterKinematic_release_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PhysXCharacterKinematic_release_objsdir),, $@))), $(PhysXCharacterKinematic_cppfiles)) -o $@
...
$(PhysXCharacterKinematic_release_cc_o): $(PhysXCharacterKinematic_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PhysXCharacterKinematic_release_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PhysXCharacterKinematic_release_objsdir),, $@))), $(PhysXCharacterKinematic_ccfiles)) -o $@
...
$(PhysXCharacterKinematic_release_c_o): $(PhysXCharacterKinematic_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(PhysXCharacterKinematic_release_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(PhysXCharacterKinematic_release_objsdir),, $@))), $(PhysXCharacterKinematic_cfiles)) -o $@ 
