...
PxFoundation_debug_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
PxFoundation_debug_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
PxFoundation_debug_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
PxFoundation_debug_common_cflags  += -march=armv8-a  -marm 
PxFoundation_debug_common_cflags  += -w
PxFoundation_debug_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
PxFoundation_debug_cflags  += -std=gnu11
PxFoundation_debug_cppflags	:= $(PxFoundation_debug_common_cflags)
PxFoundation_debug_cppflags  += -std=gnu++17 -fno-rtti
...
PxFoundation_debug_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
PxFoundation_debug_bin      := ./../../../../PxShared/Lib/android26/libPxFoundationDEBUG.a
...
$(PxFoundation_debug_bin): $(PxFoundation_debug_obj) 
	mkdir -p `dirname ./../../../../PxShared/Lib/android26/libPxFoundationDEBUG.a`
...
$(PxFoundation_debug_cpp_o): $(PxFoundation_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PxFoundation_debug_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PxFoundation_debug_objsdir),, $@))), $(PxFoundation_cppfiles)) -o $@
...
$(PxFoundation_debug_cc_o): $(PxFoundation_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PxFoundation_debug_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PxFoundation_debug_objsdir),, $@))), $(PxFoundation_ccfiles)) -o $@
...
$(PxFoundation_debug_c_o): $(PxFoundation_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(PxFoundation_debug_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(PxFoundation_debug_objsdir),, $@))), $(PxFoundation_cfiles)) -o $@ 
...
PxFoundation_release_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
PxFoundation_release_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
PxFoundation_release_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
PxFoundation_release_common_cflags  += -march=armv8-a  -marm 
PxFoundation_release_common_cflags  += -w
PxFoundation_release_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
PxFoundation_release_common_cflags  += -fomit-frame-pointer  
PxFoundation_release_cflags	:= $(PxFoundation_release_common_cflags)
PxFoundation_release_cflags  += -std=gnu11
PxFoundation_release_cppflags	:= $(PxFoundation_release_common_cflags)
PxFoundation_release_cppflags  += -std=gnu++17 -fno-rtti
...
PxFoundation_release_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
PxFoundation_release_bin      := ./../../../../PxShared/Lib/android26/libPxFoundation.a
...
$(PxFoundation_release_bin): $(PxFoundation_release_obj) 
	mkdir -p `dirname ./../../../../PxShared/Lib/android26/libPxFoundation.a`
...
$(PxFoundation_release_cpp_o): $(PxFoundation_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PxFoundation_release_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PxFoundation_release_objsdir),, $@))), $(PxFoundation_cppfiles)) -o $@
...
$(PxFoundation_release_cc_o): $(PxFoundation_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PxFoundation_release_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PxFoundation_release_objsdir),, $@))), $(PxFoundation_ccfiles)) -o $@
...
$(PxFoundation_release_c_o): $(PxFoundation_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(PxFoundation_release_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(PxFoundation_release_objsdir),, $@))), $(PxFoundation_cfiles)) -o $@ 
...
PxFoundation_checked_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
PxFoundation_checked_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
PxFoundation_checked_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
PxFoundation_checked_common_cflags  += -march=armv8-a  -marm 
PxFoundation_checked_common_cflags  += -w
PxFoundation_checked_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
PxFoundation_checked_common_cflags  += -fomit-frame-pointer  
PxFoundation_checked_cflags	:= $(PxFoundation_checked_common_cflags)
PxFoundation_checked_cflags  += -std=gnu11
PxFoundation_checked_cppflags	:= $(PxFoundation_checked_common_cflags)
PxFoundation_checked_cppflags  += -std=gnu++17 -fno-rtti
...
PxFoundation_checked_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
PxFoundation_checked_bin      := ./../../../../PxShared/Lib/android26/libPxFoundationCHECKED.a
...
$(PxFoundation_checked_bin): $(PxFoundation_checked_obj) 
	mkdir -p `dirname ./../../../../PxShared/Lib/android26/libPxFoundationCHECKED.a`
...
$(PxFoundation_checked_cpp_o): $(PxFoundation_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PxFoundation_checked_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PxFoundation_checked_objsdir),, $@))), $(PxFoundation_cppfiles)) -o $@
...
$(PxFoundation_checked_cc_o): $(PxFoundation_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PxFoundation_checked_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PxFoundation_checked_objsdir),, $@))), $(PxFoundation_ccfiles)) -o $@
...
$(PxFoundation_checked_c_o): $(PxFoundation_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(PxFoundation_checked_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(PxFoundation_checked_objsdir),, $@))), $(PxFoundation_cfiles)) -o $@ 
...
PxFoundation_profile_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
PxFoundation_profile_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
PxFoundation_profile_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
PxFoundation_profile_common_cflags  += -march=armv8-a  -marm 
PxFoundation_profile_common_cflags  += -w
PxFoundation_profile_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
PxFoundation_profile_common_cflags  += -fno-omit-frame-pointer  
PxFoundation_profile_cflags	:= $(PxFoundation_profile_common_cflags)
PxFoundation_profile_cflags  += -std=gnu11
PxFoundation_profile_cppflags	:= $(PxFoundation_profile_common_cflags)
PxFoundation_profile_cppflags  += -std=gnu++17 -fno-rtti
...
PxFoundation_profile_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
PxFoundation_profile_bin      := ./../../../../PxShared/Lib/android26/libPxFoundationPROFILE.a
...
$(PxFoundation_profile_bin): $(PxFoundation_profile_obj) 
	mkdir -p `dirname ./../../../../PxShared/Lib/android26/libPxFoundationPROFILE.a`
...
$(PxFoundation_profile_cpp_o): $(PxFoundation_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PxFoundation_profile_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PxFoundation_profile_objsdir),, $@))), $(PxFoundation_cppfiles)) -o $@
...
$(PxFoundation_profile_cc_o): $(PxFoundation_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PxFoundation_profile_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PxFoundation_profile_objsdir),, $@))), $(PxFoundation_ccfiles)) -o $@
...
$(PxFoundation_profile_c_o): $(PxFoundation_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(PxFoundation_profile_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(PxFoundation_profile_objsdir),, $@))), $(PxFoundation_cfiles)) -o $@ 
