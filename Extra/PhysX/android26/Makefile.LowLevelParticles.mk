...
LowLevelParticles_debug_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
LowLevelParticles_debug_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
LowLevelParticles_debug_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
LowLevelParticles_debug_common_cflags  += -march=armv8-a  -marm 
LowLevelParticles_debug_common_cflags  += -w
LowLevelParticles_debug_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
LowLevelParticles_debug_cflags  += -std=gnu11
LowLevelParticles_debug_cppflags	:= $(LowLevelParticles_debug_common_cflags)
LowLevelParticles_debug_cppflags  += -std=gnu++17 -fno-rtti
...
LowLevelParticles_debug_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
LowLevelParticles_debug_bin      := ./../../../Lib/android26/libLowLevelParticlesDEBUG.a
...
$(LowLevelParticles_debug_bin): $(LowLevelParticles_debug_obj) 
	mkdir -p `dirname ./../../../Lib/android26/libLowLevelParticlesDEBUG.a`
...
$(LowLevelParticles_debug_cpp_o): $(LowLevelParticles_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(LowLevelParticles_debug_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(LowLevelParticles_debug_objsdir),, $@))), $(LowLevelParticles_cppfiles)) -o $@
...
$(LowLevelParticles_debug_cc_o): $(LowLevelParticles_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(LowLevelParticles_debug_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(LowLevelParticles_debug_objsdir),, $@))), $(LowLevelParticles_ccfiles)) -o $@
...
$(LowLevelParticles_debug_c_o): $(LowLevelParticles_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(LowLevelParticles_debug_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(LowLevelParticles_debug_objsdir),, $@))), $(LowLevelParticles_cfiles)) -o $@ 
...
LowLevelParticles_checked_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
LowLevelParticles_checked_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
LowLevelParticles_checked_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
LowLevelParticles_checked_common_cflags  += -march=armv8-a  -marm 
LowLevelParticles_checked_common_cflags  += -w
LowLevelParticles_checked_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
LowLevelParticles_checked_common_cflags  += -fomit-frame-pointer  
LowLevelParticles_checked_cflags	:= $(LowLevelParticles_checked_common_cflags)
LowLevelParticles_checked_cflags  += -std=gnu11
LowLevelParticles_checked_cppflags	:= $(LowLevelParticles_checked_common_cflags)
LowLevelParticles_checked_cppflags  += -std=gnu++17 -fno-rtti
...
LowLevelParticles_checked_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
LowLevelParticles_checked_bin      := ./../../../Lib/android26/libLowLevelParticlesCHECKED.a
...
$(LowLevelParticles_checked_bin): $(LowLevelParticles_checked_obj) 
	mkdir -p `dirname ./../../../Lib/android26/libLowLevelParticlesCHECKED.a`
...
$(LowLevelParticles_checked_cpp_o): $(LowLevelParticles_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(LowLevelParticles_checked_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(LowLevelParticles_checked_objsdir),, $@))), $(LowLevelParticles_cppfiles)) -o $@
...
$(LowLevelParticles_checked_cc_o): $(LowLevelParticles_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(LowLevelParticles_checked_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(LowLevelParticles_checked_objsdir),, $@))), $(LowLevelParticles_ccfiles)) -o $@
...
$(LowLevelParticles_checked_c_o): $(LowLevelParticles_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(LowLevelParticles_checked_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(LowLevelParticles_checked_objsdir),, $@))), $(LowLevelParticles_cfiles)) -o $@ 
...
LowLevelParticles_profile_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
LowLevelParticles_profile_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
LowLevelParticles_profile_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
LowLevelParticles_profile_common_cflags  += -march=armv8-a  -marm 
LowLevelParticles_profile_common_cflags  += -w
LowLevelParticles_profile_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
LowLevelParticles_profile_common_cflags  += -fno-omit-frame-pointer  
LowLevelParticles_profile_cflags	:= $(LowLevelParticles_profile_common_cflags)
LowLevelParticles_profile_cflags  += -std=gnu11
LowLevelParticles_profile_cppflags	:= $(LowLevelParticles_profile_common_cflags)
LowLevelParticles_profile_cppflags  += -std=gnu++17 -fno-rtti
...
LowLevelParticles_profile_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
LowLevelParticles_profile_bin      := ./../../../Lib/android26/libLowLevelParticlesPROFILE.a
...
$(LowLevelParticles_profile_bin): $(LowLevelParticles_profile_obj) 
	mkdir -p `dirname ./../../../Lib/android26/libLowLevelParticlesPROFILE.a`
...
$(LowLevelParticles_profile_cpp_o): $(LowLevelParticles_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(LowLevelParticles_profile_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(LowLevelParticles_profile_objsdir),, $@))), $(LowLevelParticles_cppfiles)) -o $@
...
$(LowLevelParticles_profile_cc_o): $(LowLevelParticles_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(LowLevelParticles_profile_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(LowLevelParticles_profile_objsdir),, $@))), $(LowLevelParticles_ccfiles)) -o $@
...
$(LowLevelParticles_profile_c_o): $(LowLevelParticles_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(LowLevelParticles_profile_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(LowLevelParticles_profile_objsdir),, $@))), $(LowLevelParticles_cfiles)) -o $@ 
...
LowLevelParticles_release_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
LowLevelParticles_release_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
LowLevelParticles_release_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
LowLevelParticles_release_common_cflags  += -march=armv8-a  -marm 
LowLevelParticles_release_common_cflags  += -w
LowLevelParticles_release_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
LowLevelParticles_release_common_cflags  += -fomit-frame-pointer  
LowLevelParticles_release_cflags	:= $(LowLevelParticles_release_common_cflags)
LowLevelParticles_release_cflags  += -std=gnu11
LowLevelParticles_release_cppflags	:= $(LowLevelParticles_release_common_cflags)
LowLevelParticles_release_cppflags  += -std=gnu++17 -fno-rtti
...
LowLevelParticles_release_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
LowLevelParticles_release_bin      := ./../../../Lib/android26/libLowLevelParticles.a
...
$(LowLevelParticles_release_bin): $(LowLevelParticles_release_obj) 
	mkdir -p `dirname ./../../../Lib/android26/libLowLevelParticles.a`
...
$(LowLevelParticles_release_cpp_o): $(LowLevelParticles_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(LowLevelParticles_release_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(LowLevelParticles_release_objsdir),, $@))), $(LowLevelParticles_cppfiles)) -o $@
...
$(LowLevelParticles_release_cc_o): $(LowLevelParticles_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(LowLevelParticles_release_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(LowLevelParticles_release_objsdir),, $@))), $(LowLevelParticles_ccfiles)) -o $@
...
$(LowLevelParticles_release_c_o): $(LowLevelParticles_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(LowLevelParticles_release_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(LowLevelParticles_release_objsdir),, $@))), $(LowLevelParticles_cfiles)) -o $@ 
