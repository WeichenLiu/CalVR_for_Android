...
PhysX_release_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
PhysX_release_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
PhysX_release_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
PhysX_release_common_cflags  += -march=armv8-a  -marm 
PhysX_release_common_cflags  += -w
PhysX_release_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
PhysX_release_common_cflags  += -fomit-frame-pointer  
PhysX_release_cflags	:= $(PhysX_release_common_cflags)
PhysX_release_cflags  += -std=gnu11
PhysX_release_cppflags	:= $(PhysX_release_common_cflags)
PhysX_release_cppflags  += -std=gnu++17 -fno-rtti
...
PhysX_release_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
PhysX_release_bin      := ./../../../Lib/android26/libPhysX3.a
...
$(PhysX_release_bin): $(PhysXCommon_release_obj) $(LowLevel_release_obj) $(LowLevelAABB_release_obj) $(LowLevelDynamics_release_obj) $(LowLevelCloth_release_obj) $(LowLevelParticles_release_obj) $(SceneQuery_release_obj) $(SimulationController_release_obj) $(PxTask_release_obj) $(PhysX_release_obj) build_PxPvdSDK_release build_PxFoundation_release build_PhysXCommon_release build_LowLevel_release build_LowLevelAABB_release build_LowLevelDynamics_release build_LowLevelCloth_release build_LowLevelParticles_release build_SceneQuery_release build_SimulationController_release build_PxTask_release 
	mkdir -p `dirname ./../../../Lib/android26/libPhysX3.a`
...
$(PhysX_release_cpp_o): $(PhysX_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PhysX_release_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PhysX_release_objsdir),, $@))), $(PhysX_cppfiles)) -o $@
...
$(PhysX_release_cc_o): $(PhysX_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PhysX_release_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PhysX_release_objsdir),, $@))), $(PhysX_ccfiles)) -o $@
...
$(PhysX_release_c_o): $(PhysX_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(PhysX_release_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(PhysX_release_objsdir),, $@))), $(PhysX_cfiles)) -o $@ 
...
PhysX_debug_hpaths    := 
PhysX_debug_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
PhysX_debug_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
PhysX_debug_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
PhysX_debug_common_cflags  += -march=armv8-a  -marm 
PhysX_debug_common_cflags  += -w
PhysX_debug_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
PhysX_debug_cflags  += -std=gnu11
PhysX_debug_cppflags	:= $(PhysX_debug_common_cflags)
PhysX_debug_cppflags  += -std=gnu++17 -fno-rtti
...
PhysX_debug_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
PhysX_debug_bin      := ./../../../Lib/android26/libPhysX3DEBUG.a
...
$(PhysX_debug_bin): $(PhysXCommon_debug_obj) $(LowLevel_debug_obj) $(LowLevelAABB_debug_obj) $(LowLevelDynamics_debug_obj) $(LowLevelCloth_debug_obj) $(LowLevelParticles_debug_obj) $(SceneQuery_debug_obj) $(SimulationController_debug_obj) $(PxTask_debug_obj) $(PhysX_debug_obj) build_PxPvdSDK_debug build_PxFoundation_debug build_PhysXCommon_debug build_LowLevel_debug build_LowLevelAABB_debug build_LowLevelDynamics_debug build_LowLevelCloth_debug build_LowLevelParticles_debug build_SceneQuery_debug build_SimulationController_debug build_PxTask_debug 
	mkdir -p `dirname ./../../../Lib/android26/libPhysX3DEBUG.a`
...
$(PhysX_debug_cpp_o): $(PhysX_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PhysX_debug_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PhysX_debug_objsdir),, $@))), $(PhysX_cppfiles)) -o $@
...
$(PhysX_debug_cc_o): $(PhysX_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PhysX_debug_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PhysX_debug_objsdir),, $@))), $(PhysX_ccfiles)) -o $@
...
$(PhysX_debug_c_o): $(PhysX_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(PhysX_debug_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(PhysX_debug_objsdir),, $@))), $(PhysX_cfiles)) -o $@ 
...
PhysX_checked_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
PhysX_checked_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
PhysX_checked_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
PhysX_checked_common_cflags  += -march=armv8-a  -marm 
PhysX_checked_common_cflags  += -w
PhysX_checked_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
PhysX_checked_common_cflags  += -fomit-frame-pointer  
PhysX_checked_cflags	:= $(PhysX_checked_common_cflags)
PhysX_checked_cflags  += -std=gnu11
PhysX_checked_cppflags	:= $(PhysX_checked_common_cflags)
PhysX_checked_cppflags  += -std=gnu++17 -fno-rtti
...
PhysX_checked_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
PhysX_checked_bin      := ./../../../Lib/android26/libPhysX3CHECKED.a
...
$(PhysX_checked_bin): $(PhysXCommon_checked_obj) $(LowLevel_checked_obj) $(LowLevelAABB_checked_obj) $(LowLevelDynamics_checked_obj) $(LowLevelCloth_checked_obj) $(LowLevelParticles_checked_obj) $(SceneQuery_checked_obj) $(SimulationController_checked_obj) $(PxTask_checked_obj) $(PhysX_checked_obj) build_PxPvdSDK_checked build_PxFoundation_checked build_PhysXCommon_checked build_LowLevel_checked build_LowLevelAABB_checked build_LowLevelDynamics_checked build_LowLevelCloth_checked build_LowLevelParticles_checked build_SceneQuery_checked build_SimulationController_checked build_PxTask_checked 
	mkdir -p `dirname ./../../../Lib/android26/libPhysX3CHECKED.a`
...
$(PhysX_checked_cpp_o): $(PhysX_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PhysX_checked_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PhysX_checked_objsdir),, $@))), $(PhysX_cppfiles)) -o $@
...
$(PhysX_checked_cc_o): $(PhysX_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PhysX_checked_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PhysX_checked_objsdir),, $@))), $(PhysX_ccfiles)) -o $@
...
$(PhysX_checked_c_o): $(PhysX_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(PhysX_checked_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(PhysX_checked_objsdir),, $@))), $(PhysX_cfiles)) -o $@ 
...
PhysX_profile_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
PhysX_profile_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
PhysX_profile_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
PhysX_profile_common_cflags  += -march=armv8-a  -marm 
PhysX_profile_common_cflags  += -w
PhysX_profile_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
PhysX_profile_common_cflags  += -fno-omit-frame-pointer  
PhysX_profile_cflags	:= $(PhysX_profile_common_cflags)
PhysX_profile_cflags  += -std=gnu11
PhysX_profile_cppflags	:= $(PhysX_profile_common_cflags)
PhysX_profile_cppflags  += -std=gnu++17 -fno-rtti
...
PhysX_profile_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
PhysX_profile_bin      := ./../../../Lib/android26/libPhysX3PROFILE.a
...
$(PhysX_profile_bin): $(PhysXCommon_profile_obj) $(LowLevel_profile_obj) $(LowLevelAABB_profile_obj) $(LowLevelDynamics_profile_obj) $(LowLevelCloth_profile_obj) $(LowLevelParticles_profile_obj) $(SceneQuery_profile_obj) $(SimulationController_profile_obj) $(PxTask_profile_obj) $(PhysX_profile_obj) build_PxPvdSDK_profile build_PxFoundation_profile build_PhysXCommon_profile build_LowLevel_profile build_LowLevelAABB_profile build_LowLevelDynamics_profile build_LowLevelCloth_profile build_LowLevelParticles_profile build_SceneQuery_profile build_SimulationController_profile build_PxTask_profile 
	mkdir -p `dirname ./../../../Lib/android26/libPhysX3PROFILE.a`
...
$(PhysX_profile_cpp_o): $(PhysX_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PhysX_profile_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PhysX_profile_objsdir),, $@))), $(PhysX_cppfiles)) -o $@
...
$(PhysX_profile_cc_o): $(PhysX_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PhysX_profile_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PhysX_profile_objsdir),, $@))), $(PhysX_ccfiles)) -o $@
...
$(PhysX_profile_c_o): $(PhysX_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(PhysX_profile_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(PhysX_profile_objsdir),, $@))), $(PhysX_cfiles)) -o $@ 
