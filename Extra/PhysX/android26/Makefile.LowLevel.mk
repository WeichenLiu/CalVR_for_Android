...
LowLevel_debug_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
LowLevel_debug_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
LowLevel_debug_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
LowLevel_debug_common_cflags  += -march=armv8-a  -marm 
LowLevel_debug_common_cflags  += -w
LowLevel_debug_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
LowLevel_debug_cflags  += -std=gnu11
LowLevel_debug_cppflags	:= $(LowLevel_debug_common_cflags)
LowLevel_debug_cppflags  += -std=gnu++17 -fno-rtti
...
LowLevel_debug_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
LowLevel_debug_bin      := ./../../../Lib/android26/libLowLevelDEBUG.a
...
$(LowLevel_debug_bin): $(LowLevel_debug_obj) 
	mkdir -p `dirname ./../../../Lib/android26/libLowLevelDEBUG.a`
...
$(LowLevel_debug_cpp_o): $(LowLevel_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(LowLevel_debug_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(LowLevel_debug_objsdir),, $@))), $(LowLevel_cppfiles)) -o $@
...
$(LowLevel_debug_cc_o): $(LowLevel_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(LowLevel_debug_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(LowLevel_debug_objsdir),, $@))), $(LowLevel_ccfiles)) -o $@
...
$(LowLevel_debug_c_o): $(LowLevel_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(LowLevel_debug_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(LowLevel_debug_objsdir),, $@))), $(LowLevel_cfiles)) -o $@ 
...
LowLevel_checked_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
LowLevel_checked_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
LowLevel_checked_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
LowLevel_checked_common_cflags  += -march=armv8-a  -marm 
LowLevel_checked_common_cflags  += -w
LowLevel_checked_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
LowLevel_checked_common_cflags  += -fomit-frame-pointer  
LowLevel_checked_cflags	:= $(LowLevel_checked_common_cflags)
LowLevel_checked_cflags  += -std=gnu11
LowLevel_checked_cppflags	:= $(LowLevel_checked_common_cflags)
LowLevel_checked_cppflags  += -std=gnu++17 -fno-rtti
...
LowLevel_checked_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
LowLevel_checked_bin      := ./../../../Lib/android26/libLowLevelCHECKED.a
...
$(LowLevel_checked_bin): $(LowLevel_checked_obj) 
	mkdir -p `dirname ./../../../Lib/android26/libLowLevelCHECKED.a`
...
$(LowLevel_checked_cpp_o): $(LowLevel_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(LowLevel_checked_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(LowLevel_checked_objsdir),, $@))), $(LowLevel_cppfiles)) -o $@
...
$(LowLevel_checked_cc_o): $(LowLevel_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(LowLevel_checked_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(LowLevel_checked_objsdir),, $@))), $(LowLevel_ccfiles)) -o $@
...
$(LowLevel_checked_c_o): $(LowLevel_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(LowLevel_checked_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(LowLevel_checked_objsdir),, $@))), $(LowLevel_cfiles)) -o $@ 
...
LowLevel_profile_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
LowLevel_profile_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
LowLevel_profile_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
LowLevel_profile_common_cflags  += -march=armv8-a  -marm 
LowLevel_profile_common_cflags  += -w
LowLevel_profile_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
LowLevel_profile_common_cflags  += -fno-omit-frame-pointer  
LowLevel_profile_cflags	:= $(LowLevel_profile_common_cflags)
LowLevel_profile_cflags  += -std=gnu11
LowLevel_profile_cppflags	:= $(LowLevel_profile_common_cflags)
LowLevel_profile_cppflags  += -std=gnu++17 -fno-rtti
...
LowLevel_profile_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
LowLevel_profile_bin      := ./../../../Lib/android26/libLowLevelPROFILE.a
...
$(LowLevel_profile_bin): $(LowLevel_profile_obj) 
	mkdir -p `dirname ./../../../Lib/android26/libLowLevelPROFILE.a`
...
$(LowLevel_profile_cpp_o): $(LowLevel_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(LowLevel_profile_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(LowLevel_profile_objsdir),, $@))), $(LowLevel_cppfiles)) -o $@
...
$(LowLevel_profile_cc_o): $(LowLevel_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(LowLevel_profile_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(LowLevel_profile_objsdir),, $@))), $(LowLevel_ccfiles)) -o $@
...
$(LowLevel_profile_c_o): $(LowLevel_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(LowLevel_profile_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(LowLevel_profile_objsdir),, $@))), $(LowLevel_cfiles)) -o $@ 
...
LowLevel_release_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
LowLevel_release_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
LowLevel_release_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
LowLevel_release_common_cflags  += -march=armv8-a  -marm 
LowLevel_release_common_cflags  += -w
LowLevel_release_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
LowLevel_release_common_cflags  += -fomit-frame-pointer  
LowLevel_release_cflags	:= $(LowLevel_release_common_cflags)
LowLevel_release_cflags  += -std=gnu11
LowLevel_release_cppflags	:= $(LowLevel_release_common_cflags)
LowLevel_release_cppflags  += -std=gnu++17 -fno-rtti
...
LowLevel_release_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
LowLevel_release_bin      := ./../../../Lib/android26/libLowLevel.a
...
$(LowLevel_release_bin): $(LowLevel_release_obj) 
	mkdir -p `dirname ./../../../Lib/android26/libLowLevel.a`
...
$(LowLevel_release_cpp_o): $(LowLevel_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(LowLevel_release_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(LowLevel_release_objsdir),, $@))), $(LowLevel_cppfiles)) -o $@
...
$(LowLevel_release_cc_o): $(LowLevel_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(LowLevel_release_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(LowLevel_release_objsdir),, $@))), $(LowLevel_ccfiles)) -o $@
...
$(LowLevel_release_c_o): $(LowLevel_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(LowLevel_release_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(LowLevel_release_objsdir),, $@))), $(LowLevel_cfiles)) -o $@ 
