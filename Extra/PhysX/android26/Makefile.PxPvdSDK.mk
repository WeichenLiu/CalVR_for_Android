...
PxPvdSDK_debug_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
PxPvdSDK_debug_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
PxPvdSDK_debug_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
PxPvdSDK_debug_common_cflags  += -march=armv8-a  -marm 
PxPvdSDK_debug_common_cflags  += -w
PxPvdSDK_debug_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
PxPvdSDK_debug_cflags  += -std=gnu11
PxPvdSDK_debug_cppflags	:= $(PxPvdSDK_debug_common_cflags)
PxPvdSDK_debug_cppflags  += -std=gnu++17 -fno-rtti
...
PxPvdSDK_debug_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
PxPvdSDK_debug_bin      := ./../../../../PxShared/Lib/android26/libPxPvdSDKDEBUG.a
...
$(PxPvdSDK_debug_bin): $(PxPvdSDK_debug_obj) build_PxFoundation_debug 
	mkdir -p `dirname ./../../../../PxShared/Lib/android26/libPxPvdSDKDEBUG.a`
...
$(PxPvdSDK_debug_cpp_o): $(PxPvdSDK_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PxPvdSDK_debug_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PxPvdSDK_debug_objsdir),, $@))), $(PxPvdSDK_cppfiles)) -o $@
...
$(PxPvdSDK_debug_cc_o): $(PxPvdSDK_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PxPvdSDK_debug_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PxPvdSDK_debug_objsdir),, $@))), $(PxPvdSDK_ccfiles)) -o $@
...
$(PxPvdSDK_debug_c_o): $(PxPvdSDK_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(PxPvdSDK_debug_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(PxPvdSDK_debug_objsdir),, $@))), $(PxPvdSDK_cfiles)) -o $@ 
...
PxPvdSDK_release_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
PxPvdSDK_release_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
PxPvdSDK_release_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
PxPvdSDK_release_common_cflags  += -march=armv8-a  -marm 
PxPvdSDK_release_common_cflags  += -w
PxPvdSDK_release_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
PxPvdSDK_release_common_cflags  += -fomit-frame-pointer  
PxPvdSDK_release_cflags	:= $(PxPvdSDK_release_common_cflags)
PxPvdSDK_release_cflags  += -std=gnu11
PxPvdSDK_release_cppflags	:= $(PxPvdSDK_release_common_cflags)
PxPvdSDK_release_cppflags  += -std=gnu++17 -fno-rtti
...
PxPvdSDK_release_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
PxPvdSDK_release_bin      := ./../../../../PxShared/Lib/android26/libPxPvdSDK.a
...
$(PxPvdSDK_release_bin): $(PxPvdSDK_release_obj) build_PxFoundation_release 
	mkdir -p `dirname ./../../../../PxShared/Lib/android26/libPxPvdSDK.a`
...
$(PxPvdSDK_release_cpp_o): $(PxPvdSDK_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PxPvdSDK_release_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PxPvdSDK_release_objsdir),, $@))), $(PxPvdSDK_cppfiles)) -o $@
...
$(PxPvdSDK_release_cc_o): $(PxPvdSDK_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PxPvdSDK_release_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PxPvdSDK_release_objsdir),, $@))), $(PxPvdSDK_ccfiles)) -o $@
...
$(PxPvdSDK_release_c_o): $(PxPvdSDK_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(PxPvdSDK_release_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(PxPvdSDK_release_objsdir),, $@))), $(PxPvdSDK_cfiles)) -o $@ 
...
PxPvdSDK_checked_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
PxPvdSDK_checked_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
PxPvdSDK_checked_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
PxPvdSDK_checked_common_cflags  += -march=armv8-a  -marm 
PxPvdSDK_checked_common_cflags  += -w
PxPvdSDK_checked_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
PxPvdSDK_checked_common_cflags  += -fomit-frame-pointer  
PxPvdSDK_checked_cflags	:= $(PxPvdSDK_checked_common_cflags)
PxPvdSDK_checked_cflags  += -std=gnu11
PxPvdSDK_checked_cppflags	:= $(PxPvdSDK_checked_common_cflags)
PxPvdSDK_checked_cppflags  += -std=gnu++17 -fno-rtti
...
PxPvdSDK_checked_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
PxPvdSDK_checked_bin      := ./../../../../PxShared/Lib/android26/libPxPvdSDKCHECKED.a
...
$(PxPvdSDK_checked_bin): $(PxPvdSDK_checked_obj) build_PxFoundation_checked 
	mkdir -p `dirname ./../../../../PxShared/Lib/android26/libPxPvdSDKCHECKED.a`
...
$(PxPvdSDK_checked_cpp_o): $(PxPvdSDK_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PxPvdSDK_checked_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PxPvdSDK_checked_objsdir),, $@))), $(PxPvdSDK_cppfiles)) -o $@
...
$(PxPvdSDK_checked_cc_o): $(PxPvdSDK_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PxPvdSDK_checked_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PxPvdSDK_checked_objsdir),, $@))), $(PxPvdSDK_ccfiles)) -o $@
...
$(PxPvdSDK_checked_c_o): $(PxPvdSDK_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(PxPvdSDK_checked_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(PxPvdSDK_checked_objsdir),, $@))), $(PxPvdSDK_cfiles)) -o $@ 
...
PxPvdSDK_profile_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
PxPvdSDK_profile_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
PxPvdSDK_profile_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
PxPvdSDK_profile_common_cflags  += -march=armv8-a  -marm 
PxPvdSDK_profile_common_cflags  += -w
PxPvdSDK_profile_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
PxPvdSDK_profile_common_cflags  += -fno-omit-frame-pointer  
PxPvdSDK_profile_cflags	:= $(PxPvdSDK_profile_common_cflags)
PxPvdSDK_profile_cflags  += -std=gnu11
PxPvdSDK_profile_cppflags	:= $(PxPvdSDK_profile_common_cflags)
PxPvdSDK_profile_cppflags  += -std=gnu++17 -fno-rtti
...
PxPvdSDK_profile_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
PxPvdSDK_profile_bin      := ./../../../../PxShared/Lib/android26/libPxPvdSDKPROFILE.a
...
$(PxPvdSDK_profile_bin): $(PxPvdSDK_profile_obj) build_PxFoundation_profile 
	mkdir -p `dirname ./../../../../PxShared/Lib/android26/libPxPvdSDKPROFILE.a`
...
$(PxPvdSDK_profile_cpp_o): $(PxPvdSDK_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PxPvdSDK_profile_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PxPvdSDK_profile_objsdir),, $@))), $(PxPvdSDK_cppfiles)) -o $@
...
$(PxPvdSDK_profile_cc_o): $(PxPvdSDK_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PxPvdSDK_profile_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PxPvdSDK_profile_objsdir),, $@))), $(PxPvdSDK_ccfiles)) -o $@
...
$(PxPvdSDK_profile_c_o): $(PxPvdSDK_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(PxPvdSDK_profile_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(PxPvdSDK_profile_objsdir),, $@))), $(PxPvdSDK_cfiles)) -o $@ 
