...
LowLevelCloth_debug_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
LowLevelCloth_debug_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
LowLevelCloth_debug_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
LowLevelCloth_debug_common_cflags  += -march=armv8-a  -marm 
LowLevelCloth_debug_common_cflags  += -w
LowLevelCloth_debug_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
LowLevelCloth_debug_cflags  += -std=gnu11
LowLevelCloth_debug_cppflags	:= $(LowLevelCloth_debug_common_cflags)
LowLevelCloth_debug_cppflags  += -std=gnu++17 -fno-rtti
...
LowLevelCloth_debug_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
LowLevelCloth_debug_bin      := ./../../../Lib/android26/libLowLevelClothDEBUG.a
...
$(LowLevelCloth_debug_bin): $(LowLevelCloth_debug_obj) 
	mkdir -p `dirname ./../../../Lib/android26/libLowLevelClothDEBUG.a`
...
$(LowLevelCloth_debug_cpp_o): $(LowLevelCloth_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(LowLevelCloth_debug_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(LowLevelCloth_debug_objsdir),, $@))), $(LowLevelCloth_cppfiles)) -o $@
...
$(LowLevelCloth_debug_cc_o): $(LowLevelCloth_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(LowLevelCloth_debug_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(LowLevelCloth_debug_objsdir),, $@))), $(LowLevelCloth_ccfiles)) -o $@
...
$(LowLevelCloth_debug_c_o): $(LowLevelCloth_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(LowLevelCloth_debug_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(LowLevelCloth_debug_objsdir),, $@))), $(LowLevelCloth_cfiles)) -o $@ 
...
LowLevelCloth_checked_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
LowLevelCloth_checked_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
LowLevelCloth_checked_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
LowLevelCloth_checked_common_cflags  += -march=armv8-a  -marm 
LowLevelCloth_checked_common_cflags  += -w
LowLevelCloth_checked_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
LowLevelCloth_checked_common_cflags  += -fomit-frame-pointer  
LowLevelCloth_checked_cflags	:= $(LowLevelCloth_checked_common_cflags)
LowLevelCloth_checked_cflags  += -std=gnu11
LowLevelCloth_checked_cppflags	:= $(LowLevelCloth_checked_common_cflags)
LowLevelCloth_checked_cppflags  += -std=gnu++17 -fno-rtti
...
LowLevelCloth_checked_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
LowLevelCloth_checked_bin      := ./../../../Lib/android26/libLowLevelClothCHECKED.a
...
$(LowLevelCloth_checked_bin): $(LowLevelCloth_checked_obj) 
	mkdir -p `dirname ./../../../Lib/android26/libLowLevelClothCHECKED.a`
...
$(LowLevelCloth_checked_cpp_o): $(LowLevelCloth_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(LowLevelCloth_checked_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(LowLevelCloth_checked_objsdir),, $@))), $(LowLevelCloth_cppfiles)) -o $@
...
$(LowLevelCloth_checked_cc_o): $(LowLevelCloth_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(LowLevelCloth_checked_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(LowLevelCloth_checked_objsdir),, $@))), $(LowLevelCloth_ccfiles)) -o $@
...
$(LowLevelCloth_checked_c_o): $(LowLevelCloth_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(LowLevelCloth_checked_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(LowLevelCloth_checked_objsdir),, $@))), $(LowLevelCloth_cfiles)) -o $@ 
...
LowLevelCloth_profile_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
LowLevelCloth_profile_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
LowLevelCloth_profile_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
LowLevelCloth_profile_common_cflags  += -march=armv8-a  -marm 
LowLevelCloth_profile_common_cflags  += -w
LowLevelCloth_profile_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
LowLevelCloth_profile_common_cflags  += -fno-omit-frame-pointer  
LowLevelCloth_profile_cflags	:= $(LowLevelCloth_profile_common_cflags)
LowLevelCloth_profile_cflags  += -std=gnu11
LowLevelCloth_profile_cppflags	:= $(LowLevelCloth_profile_common_cflags)
LowLevelCloth_profile_cppflags  += -std=gnu++17 -fno-rtti
...
LowLevelCloth_profile_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
LowLevelCloth_profile_bin      := ./../../../Lib/android26/libLowLevelClothPROFILE.a
...
$(LowLevelCloth_profile_bin): $(LowLevelCloth_profile_obj) 
	mkdir -p `dirname ./../../../Lib/android26/libLowLevelClothPROFILE.a`
...
$(LowLevelCloth_profile_cpp_o): $(LowLevelCloth_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(LowLevelCloth_profile_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(LowLevelCloth_profile_objsdir),, $@))), $(LowLevelCloth_cppfiles)) -o $@
...
$(LowLevelCloth_profile_cc_o): $(LowLevelCloth_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(LowLevelCloth_profile_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(LowLevelCloth_profile_objsdir),, $@))), $(LowLevelCloth_ccfiles)) -o $@
...
$(LowLevelCloth_profile_c_o): $(LowLevelCloth_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(LowLevelCloth_profile_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(LowLevelCloth_profile_objsdir),, $@))), $(LowLevelCloth_cfiles)) -o $@ 
...
LowLevelCloth_release_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
LowLevelCloth_release_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
LowLevelCloth_release_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
LowLevelCloth_release_common_cflags  += -march=armv8-a  -marm 
LowLevelCloth_release_common_cflags  += -w
LowLevelCloth_release_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
LowLevelCloth_release_common_cflags  += -fomit-frame-pointer  
LowLevelCloth_release_cflags	:= $(LowLevelCloth_release_common_cflags)
LowLevelCloth_release_cflags  += -std=gnu11
LowLevelCloth_release_cppflags	:= $(LowLevelCloth_release_common_cflags)
LowLevelCloth_release_cppflags  += -std=gnu++17 -fno-rtti
...
LowLevelCloth_release_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
LowLevelCloth_release_bin      := ./../../../Lib/android26/libLowLevelCloth.a
...
$(LowLevelCloth_release_bin): $(LowLevelCloth_release_obj) 
	mkdir -p `dirname ./../../../Lib/android26/libLowLevelCloth.a`
...
$(LowLevelCloth_release_cpp_o): $(LowLevelCloth_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(LowLevelCloth_release_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(LowLevelCloth_release_objsdir),, $@))), $(LowLevelCloth_cppfiles)) -o $@
...
$(LowLevelCloth_release_cc_o): $(LowLevelCloth_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(LowLevelCloth_release_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(LowLevelCloth_release_objsdir),, $@))), $(LowLevelCloth_ccfiles)) -o $@
...
$(LowLevelCloth_release_c_o): $(LowLevelCloth_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(LowLevelCloth_release_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(LowLevelCloth_release_objsdir),, $@))), $(LowLevelCloth_cfiles)) -o $@ 
