...
PhysXCommon_cfiles   += ./../../../../Externals/android-ndk-r15c/sources/android/cpufeatures/cpu-features.c
...
PhysXCommon_release_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
PhysXCommon_release_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
PhysXCommon_release_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/android/cpufeatures
...
PhysXCommon_release_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
PhysXCommon_release_common_cflags  += -march=armv8-a  -marm 
PhysXCommon_release_common_cflags  += -w
PhysXCommon_release_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
PhysXCommon_release_common_cflags  += -fomit-frame-pointer  
PhysXCommon_release_cflags	:= $(PhysXCommon_release_common_cflags)
PhysXCommon_release_cflags  += -std=gnu11
PhysXCommon_release_cppflags	:= $(PhysXCommon_release_common_cflags)
PhysXCommon_release_cppflags  += -std=gnu++17 -fno-rtti
...
PhysXCommon_release_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
PhysXCommon_release_bin      := ./../../../Lib/android26/libPhysX3Common.a
...
$(PhysXCommon_release_bin): $(PhysXCommon_release_obj) build_PxFoundation_release 
	mkdir -p `dirname ./../../../Lib/android26/libPhysX3Common.a`
...
$(PhysXCommon_release_cpp_o): $(PhysXCommon_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PhysXCommon_release_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PhysXCommon_release_objsdir),, $@))), $(PhysXCommon_cppfiles)) -o $@
...
$(PhysXCommon_release_cc_o): $(PhysXCommon_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PhysXCommon_release_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PhysXCommon_release_objsdir),, $@))), $(PhysXCommon_ccfiles)) -o $@
...
$(PhysXCommon_release_c_o): $(PhysXCommon_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(PhysXCommon_release_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(PhysXCommon_release_objsdir),, $@))), $(PhysXCommon_cfiles)) -o $@ 
...
PhysXCommon_debug_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
PhysXCommon_debug_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
PhysXCommon_debug_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/android/cpufeatures
...
PhysXCommon_debug_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
PhysXCommon_debug_common_cflags  += -march=armv8-a  -marm 
PhysXCommon_debug_common_cflags  += -w
PhysXCommon_debug_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
PhysXCommon_debug_cflags  += -std=gnu11
PhysXCommon_debug_cppflags	:= $(PhysXCommon_debug_common_cflags)
PhysXCommon_debug_cppflags  += -std=gnu++17 -fno-rtti
...
PhysXCommon_debug_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
PhysXCommon_debug_bin      := ./../../../Lib/android26/libPhysX3CommonDEBUG.a
...
$(PhysXCommon_debug_bin): $(PhysXCommon_debug_obj) build_PxFoundation_debug 
	mkdir -p `dirname ./../../../Lib/android26/libPhysX3CommonDEBUG.a`
...
$(PhysXCommon_debug_cpp_o): $(PhysXCommon_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PhysXCommon_debug_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PhysXCommon_debug_objsdir),, $@))), $(PhysXCommon_cppfiles)) -o $@
...
$(PhysXCommon_debug_cc_o): $(PhysXCommon_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PhysXCommon_debug_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PhysXCommon_debug_objsdir),, $@))), $(PhysXCommon_ccfiles)) -o $@
...
$(PhysXCommon_debug_c_o): $(PhysXCommon_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(PhysXCommon_debug_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(PhysXCommon_debug_objsdir),, $@))), $(PhysXCommon_cfiles)) -o $@ 
...
PhysXCommon_checked_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
PhysXCommon_checked_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
PhysXCommon_checked_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/android/cpufeatures
...
PhysXCommon_checked_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
PhysXCommon_checked_common_cflags  += -march=armv8-a  -marm 
PhysXCommon_checked_common_cflags  += -w
PhysXCommon_checked_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
PhysXCommon_checked_common_cflags  += -fomit-frame-pointer  
PhysXCommon_checked_cflags	:= $(PhysXCommon_checked_common_cflags)
PhysXCommon_checked_cflags  += -std=gnu11
PhysXCommon_checked_cppflags	:= $(PhysXCommon_checked_common_cflags)
PhysXCommon_checked_cppflags  += -std=gnu++17 -fno-rtti
...
PhysXCommon_checked_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
PhysXCommon_checked_bin      := ./../../../Lib/android26/libPhysX3CommonCHECKED.a
...
$(PhysXCommon_checked_bin): $(PhysXCommon_checked_obj) build_PxFoundation_checked 
	mkdir -p `dirname ./../../../Lib/android26/libPhysX3CommonCHECKED.a`
...
$(PhysXCommon_checked_cpp_o): $(PhysXCommon_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PhysXCommon_checked_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PhysXCommon_checked_objsdir),, $@))), $(PhysXCommon_cppfiles)) -o $@
...
$(PhysXCommon_checked_cc_o): $(PhysXCommon_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PhysXCommon_checked_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PhysXCommon_checked_objsdir),, $@))), $(PhysXCommon_ccfiles)) -o $@
...
$(PhysXCommon_checked_c_o): $(PhysXCommon_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(PhysXCommon_checked_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(PhysXCommon_checked_objsdir),, $@))), $(PhysXCommon_cfiles)) -o $@ 
...
PhysXCommon_profile_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
PhysXCommon_profile_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
PhysXCommon_profile_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/android/cpufeatures
...
PhysXCommon_profile_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
PhysXCommon_profile_common_cflags  += -march=armv8-a  -marm 
PhysXCommon_profile_common_cflags  += -w
PhysXCommon_profile_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
PhysXCommon_profile_common_cflags  += -fno-omit-frame-pointer  
PhysXCommon_profile_cflags	:= $(PhysXCommon_profile_common_cflags)
PhysXCommon_profile_cflags  += -std=gnu11
PhysXCommon_profile_cppflags	:= $(PhysXCommon_profile_common_cflags)
PhysXCommon_profile_cppflags  += -std=gnu++17 -fno-rtti
...
PhysXCommon_profile_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
PhysXCommon_profile_bin      := ./../../../Lib/android26/libPhysX3CommonPROFILE.a
...
$(PhysXCommon_profile_bin): $(PhysXCommon_profile_obj) build_PxFoundation_profile 
	mkdir -p `dirname ./../../../Lib/android26/libPhysX3CommonPROFILE.a`
...
$(PhysXCommon_profile_cpp_o): $(PhysXCommon_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PhysXCommon_profile_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PhysXCommon_profile_objsdir),, $@))), $(PhysXCommon_cppfiles)) -o $@
...
$(PhysXCommon_profile_cc_o): $(PhysXCommon_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(PhysXCommon_profile_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PhysXCommon_profile_objsdir),, $@))), $(PhysXCommon_ccfiles)) -o $@
...
$(PhysXCommon_profile_c_o): $(PhysXCommon_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(PhysXCommon_profile_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(PhysXCommon_profile_objsdir),, $@))), $(PhysXCommon_cfiles)) -o $@ 
