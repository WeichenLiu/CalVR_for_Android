...
SceneQuery_debug_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
SceneQuery_debug_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
SceneQuery_debug_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
SceneQuery_debug_common_cflags  += -march=armv8-a  -marm 
SceneQuery_debug_common_cflags  += -w
SceneQuery_debug_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
SceneQuery_debug_cflags  += -std=gnu11
SceneQuery_debug_cppflags	:= $(SceneQuery_debug_common_cflags)
SceneQuery_debug_cppflags  += -std=gnu++17 -fno-rtti
...
SceneQuery_debug_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
SceneQuery_debug_bin      := ./../../../Lib/android26/libSceneQueryDEBUG.a
...
$(SceneQuery_debug_bin): $(SceneQuery_debug_obj) 
	mkdir -p `dirname ./../../../Lib/android26/libSceneQueryDEBUG.a`
...
$(SceneQuery_debug_cpp_o): $(SceneQuery_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(SceneQuery_debug_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(SceneQuery_debug_objsdir),, $@))), $(SceneQuery_cppfiles)) -o $@
...
$(SceneQuery_debug_cc_o): $(SceneQuery_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(SceneQuery_debug_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(SceneQuery_debug_objsdir),, $@))), $(SceneQuery_ccfiles)) -o $@
...
$(SceneQuery_debug_c_o): $(SceneQuery_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(SceneQuery_debug_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(SceneQuery_debug_objsdir),, $@))), $(SceneQuery_cfiles)) -o $@ 
...
SceneQuery_checked_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
SceneQuery_checked_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
SceneQuery_checked_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
SceneQuery_checked_common_cflags  += -march=armv8-a  -marm 
SceneQuery_checked_common_cflags  += -w
SceneQuery_checked_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
SceneQuery_checked_common_cflags  += -fomit-frame-pointer  
SceneQuery_checked_cflags	:= $(SceneQuery_checked_common_cflags)
SceneQuery_checked_cflags  += -std=gnu11
SceneQuery_checked_cppflags	:= $(SceneQuery_checked_common_cflags)
SceneQuery_checked_cppflags  += -std=gnu++17 -fno-rtti
...
SceneQuery_checked_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
SceneQuery_checked_bin      := ./../../../Lib/android26/libSceneQueryCHECKED.a
...
$(SceneQuery_checked_bin): $(SceneQuery_checked_obj) 
	mkdir -p `dirname ./../../../Lib/android26/libSceneQueryCHECKED.a`
...
$(SceneQuery_checked_cpp_o): $(SceneQuery_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(SceneQuery_checked_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(SceneQuery_checked_objsdir),, $@))), $(SceneQuery_cppfiles)) -o $@
...
$(SceneQuery_checked_cc_o): $(SceneQuery_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(SceneQuery_checked_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(SceneQuery_checked_objsdir),, $@))), $(SceneQuery_ccfiles)) -o $@
...
$(SceneQuery_checked_c_o): $(SceneQuery_checked_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(SceneQuery_checked_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(SceneQuery_checked_objsdir),, $@))), $(SceneQuery_cfiles)) -o $@ 
...
SceneQuery_profile_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
SceneQuery_profile_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
SceneQuery_profile_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
SceneQuery_profile_common_cflags  += -march=armv8-a  -marm 
SceneQuery_profile_common_cflags  += -w
SceneQuery_profile_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
SceneQuery_profile_common_cflags  += -fno-omit-frame-pointer  
SceneQuery_profile_cflags	:= $(SceneQuery_profile_common_cflags)
SceneQuery_profile_cflags  += -std=gnu11
SceneQuery_profile_cppflags	:= $(SceneQuery_profile_common_cflags)
SceneQuery_profile_cppflags  += -std=gnu++17 -fno-rtti
...
SceneQuery_profile_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
SceneQuery_profile_bin      := ./../../../Lib/android26/libSceneQueryPROFILE.a
...
$(SceneQuery_profile_bin): $(SceneQuery_profile_obj) 
	mkdir -p `dirname ./../../../Lib/android26/libSceneQueryPROFILE.a`
...
$(SceneQuery_profile_cpp_o): $(SceneQuery_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(SceneQuery_profile_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(SceneQuery_profile_objsdir),, $@))), $(SceneQuery_cppfiles)) -o $@
...
$(SceneQuery_profile_cc_o): $(SceneQuery_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(SceneQuery_profile_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(SceneQuery_profile_objsdir),, $@))), $(SceneQuery_ccfiles)) -o $@
...
$(SceneQuery_profile_c_o): $(SceneQuery_profile_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(SceneQuery_profile_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(SceneQuery_profile_objsdir),, $@))), $(SceneQuery_cfiles)) -o $@ 
...
SceneQuery_release_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/include
SceneQuery_release_hpaths    += ./../../../../Externals/android-ndk-r15c/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a/include
...
SceneQuery_release_common_cflags  += --sysroot ../../../../Externals/android-ndk-r15c/sysroot -isystem ../../../../Externals/android-ndk-r15c/sysroot/usr/include/aarch64-linux-android
SceneQuery_release_common_cflags  += -march=armv8-a  -marm 
SceneQuery_release_common_cflags  += -w
SceneQuery_release_common_cflags  += -Wno-uninitialized -Wno-unused-variable
...
SceneQuery_release_common_cflags  += -fomit-frame-pointer  
SceneQuery_release_cflags	:= $(SceneQuery_release_common_cflags)
SceneQuery_release_cflags  += -std=gnu11
SceneQuery_release_cppflags	:= $(SceneQuery_release_common_cflags)
SceneQuery_release_cppflags  += -std=gnu++17 -fno-rtti
...
SceneQuery_release_lflags  += --sysroot=../../../../Externals/android-ndk-r15c/platforms/android-26/arch-arm64
...
SceneQuery_release_bin      := ./../../../Lib/android26/libSceneQuery.a
...
$(SceneQuery_release_bin): $(SceneQuery_release_obj) 
	mkdir -p `dirname ./../../../Lib/android26/libSceneQuery.a`
...
$(SceneQuery_release_cpp_o): $(SceneQuery_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(SceneQuery_release_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(SceneQuery_release_objsdir),, $@))), $(SceneQuery_cppfiles)) -o $@
...
$(SceneQuery_release_cc_o): $(SceneQuery_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CXX) $(TARGET) $(SceneQuery_release_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(SceneQuery_release_objsdir),, $@))), $(SceneQuery_ccfiles)) -o $@
...
$(SceneQuery_release_c_o): $(SceneQuery_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(@))
	$(CC) $(TARGET) $(SceneQuery_release_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(SceneQuery_release_objsdir),, $@))), $(SceneQuery_cfiles)) -o $@ 
